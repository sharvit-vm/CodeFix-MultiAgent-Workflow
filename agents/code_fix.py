...
from tools.file_tool import read_file, read_file_range, write_fix, get_token_count
...
def _open_pr(repo_full_name, branch_name, base_branch, event, rca, changed_files):
    ...
    issue_ref = f"Closes #{event.github_issue_number}" if event.github_issue_number else ""
...
"""
    ...
    try:
        commit_msg = (
            ...
            f"Fixes #{event.github_issue_number or 'unknown'}\n\n"
